                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills nav-justified" role="tablist">
                                ...
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" data-toggle="tab" href="#profile" role="tab">
                                        <span class="d-none d-md-block">Profil</span><span class="d-block d-md-none"><i class="mdi mdi-account h5"></i></span>
                                    </a>
                                </li>
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" data-toggle="tab" href="#email" role="tab">
                                        <span class="d-none d-md-block">Email</span><span class="d-block d-md-none"><i class="mdi mdi-account h5"></i></span>
                                    </a>
                                </li>
                                <li class="nav-item waves-effect waves-light">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active p-3" id="logo" role="tabpanel">
                                    {{Form::model($settings,array('url'=>'pengaturan','method'=>'POST','enctype' => "multipart/form-data"))}}
                                    <div class="card-body">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-4">
                                ...
                                <div class="tab-pane p-3" id="profile" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    {{Form::label('company_name *',__('Nama *')) }}
                                ...
                                <div class="tab-pane p-3" id="email" role="tabpanel" aria-labelledby="contact-tab4">
                                    <div class="email-wrap">
                                        {{Form::open(array('route'=>'email.setting','method'=>'post'))}}
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                {{Form::label('mail_driver',__('Driver Email')) }}
                                            ...
                                            <div class="form-group col-md-4">
                                                {{Form::label('mail_host',__('Host Email')) }}
                                            ...
                                            <div class="form-group col-md-4">
                                                {{Form::label('mail_port',__('Port Email')) }}
                                            ...
                                            <div class="form-group col-md-4">
                                                {{Form::label('mail_username',__('Email')) }}
                                            ...
                                            <div class="form-group col-md-4">
                                                {{Form::label('mail_password',__('Kata sandi Email')) }}
                                            ...
                                            <div class="form-group col-md-4">
                                                {{Form::label('mail_encryption',__('Enkripsi EMail')) }}
                                            ...
                                            <div class="form-group col-md-4">
                                                {{Form::label('mail_from_address',__('Email dari')) }}
                                            ...
                                            <div class="form-group col-md-4">
                                                {{Form::label('mail_from_name',__('Nama Email dari')) }}
                                ...
                                <div class="tab-pane p-3" id="social-media" role="tabpanel">
                                    <div class="row">
                                        {{Form::model($settings,array('route'=>'sosmed.setting','method'=>'post'))}}
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    {{Form::label('company_fb *',__('Nama Facebook *')) }}
